...
if ($user = $this->GetUser()) {
    ...
    if (1 == $_REQUEST['bydate'] || 1 == $bydate) {
        print('<strong>' . $this->GetResourceValue('ListOwnedPages2') . '.</strong>');

        print('<br><small><strong>(<a href="'
              . $this->href('', $tag)
              . '">'
              . $this->GetResourceValue('OrderABC')
              . '</a>) (<a href="'
              . $this->href('', $tag)
              . ''
              . ($this->GetConfigValue('rewrite_mode') ? '?' : '&amp;')
              . 'bychange=1">'
              . $this->GetResourceValue('OrderChange')
              . "</a>) </strong></small><br><br>\n");
    ...
    } elseif (1 == $_REQUEST['bychange'] || 1 == $bychange) {
        ...
        print('<br><small><strong>(<a href="'
              ...
              . ($this->GetConfigValue('rewrite_mode') ? '?' : '&amp;')
              . 'bydate=1">'
              . $this->GetResourceValue('OrderDate')
              . "</a>)</strong></small><br><br>\n");
