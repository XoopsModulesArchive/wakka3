...
if ($registered
    ...
    // если нет прав на запись и не админ, то ограничить возможности
        ...
        if ($global) { ?>
            <tr>
                ...
                <td style="font-size:11px">
                    <div>
                        <input type="radio" name="_to" disabled="disabled" checked value="global" id="toUploadGlobalDisabled">
        ...
        <?php } else { ?>
            <tr>
                ...
                <td style="font-size:11px">
                    ...
                    <div>
                        <input type="radio" name="to" value="here" checked id="toUploadHere">
