...
<div class="header">
    <h1>
        <?php echo file_exists('images/' . $this->config['wakka_name'] . '.png') ? "<img src='/images/" . $this->config['wakka_name'] . ".png' alt='" . $this->config['wakka_name'] . "'>" : $this->config['wakka_name'] ?> : <a
