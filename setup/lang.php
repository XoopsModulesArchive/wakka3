<form action="<?php echo myLocation() ?>?installAction=default" method="post">
    <table>
        ...
        <tr>
            <td></td>
            <td><br><strong><?php echo $lang['langConf']; ?></strong></td>
        </tr>
        <tr>
            <td></td>
            <td><?php echo $lang['langDesc']; ?></td>
        </tr>
        <tr>
            <td align="right" nowrap><?php echo $lang['lang']; ?>:</td>
            <td>
        ...
        <tr>
            <td></td>
            <td><input type="submit" value="<?php echo $lang['Continue']; ?>"></td>
        </tr>
    </table>
</form>
