...
<div class="page">
    ...
    if ($this->UserIsOwner()) {
        if ($_POST) {
            $this->SaveMeta($this->GetPageTag(), ['lang' => $_POST['lang'], 'description' => $_POST['description'], 'keywords' => $_POST['keywords']]);
...
<li><a href="<?php echo $this->href('revisions') . '">' . $this->GetResourceValue('SettingsRevisions'); ?></a></li>
                    <li><a href="<?php echo $this->href('rename') . '">' . $this->GetResourceValue('SettingsRename'); ?></a></li>
<li><a href="<?php echo $this->href('remove') . '">' . $this->GetResourceValue('SettingsRemove'); ?></a></li>
                    <li><a href="<?php echo $this->href('acls') . '">' . $this->GetResourceValue('SettingsAcls'); ?></a></li>
<li><a href="<?php echo $this->href('massacls') . '">' . $this->GetResourceValue('SettingsMassAcls'); ?></a></li>
