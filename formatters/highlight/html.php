 ...
 * @copyright Copyright 2005 Davey Shafik and Synaptic Media. All Rights Reserved.
 */
...
$source = htmlentities($text, ENT_QUOTES | ENT_HTML5);
$source = preg_replace(
    '/&lt;!--(.*?)--&gt;/es',
...
$source = preg_replace('([[:space:]]|&quot;|\'|\?)&gt;', '\\1<span style="color: ' . $options['color']['tags'] . ';font-weight:bold;">&gt;</span>', $source);
$source = preg_replace(
    "/([a-z-]+)=(&quot;|\')(.*?)\\2/i",
    '<span style="color: ' . $options['color']['attributes'] . ';font-weight:bold;">$1=</span><span style="color: ' . $options['color']['attributevalues'] . ';">$2$3$2</span>',
    $source
);
$source = preg_replace(
    '/&amp;([a-z0-9]*?;)/i',
